            ...
            <div class="product_tab fix">
                ...
                <div class="tab-content produc_tab_c">
                    <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                        <div class="modal_img">
                            <a href="#"><img src="{{asset('upload/product/'.$model->image)}}" alt=""></a>
                            <div class="img_icone">
                                <img src="assets\img\cart\span-new.png" alt="">
                            </div>
                            <div class="view_img">
                                <a class="large_view" href="{{asset('upload/product/'.$model->image)}}"><i class="fa fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-7 col-md-6">
            <div class="product_d_right">
                ...
                <div class="content_price mb-15">
                    ...
                    <span class="product_price">{{number_format($model->sale_price)}}đ</span>
                    <span class="old-price">{{number_format($model->price)}}đ</span>
                    @else
                    <span class="old-price">{{number_format($model->price)}}đ</span>
                    @endif
                </div>
                <div class="box_quantity mb-20">
                    ...
                    <a href="" data-url="{{route('AddCart',['id'=>$model->id])}}" class="add_to_cart"> <i class="fa fa-shopping-cart"></i> Add to cart</a>
